...
require 'offsite_payments_migs'

OffsitePaymentsMigs.mode = :test
...
module OffsitePaymentsMigs
  module Assertions
    ...
    def assert_deprecation_warning(message)
      OffsitePaymentsMigs.expects(:deprecated).with(message)
      yield
    end

    def silence_deprecation_warnings
      OffsitePaymentsMigs.stubs(:deprecated)
      yield
    end

    def assert_no_deprecation_warning
      OffsitePaymentsMigs.expects(:deprecated).never
      yield
    end
...
Test::Unit::TestCase.class_eval do
  include OffsitePaymentsMigs
  # include OffsitePaymentsMigs::Assertions
  # include OffsitePaymentsMigs::Fixtures
end

module ActionViewHelperTestHelper
  def self.included(base)
    base.send(:include, OffsitePaymentsMigs::ActionViewHelper)
